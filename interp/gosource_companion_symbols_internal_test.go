...
func TestBashPPCompanionTrampolineGo(t *testing.T) {
	...
	for _, want := range []string{"func target() {", `callback("\x00gosource.companion.target"`, "if len(out)!=0"} {
