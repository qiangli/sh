...
var nodeByName = map[string]reflect.Type{
	...
	"BashPPBasicLit":       reflect.TypeFor[syntax.BashPPBasicLit](),
	"BashPPIdent":          reflect.TypeFor[syntax.BashPPIdent](),
	"BashPPParenExpr":      reflect.TypeFor[syntax.BashPPParenExpr](),
	"BashPPUnaryExpr":      reflect.TypeFor[syntax.BashPPUnaryExpr](),
	"BashPPBinaryExpr":     reflect.TypeFor[syntax.BashPPBinaryExpr](),
	"BashPPConvertExpr":    reflect.TypeFor[syntax.BashPPConvertExpr](),
	"BashPPIndexExpr":      reflect.TypeFor[syntax.BashPPIndexExpr](),
	"BashPPSliceExpr":      reflect.TypeFor[syntax.BashPPSliceExpr](),
	"BashPPSelectorExpr":   reflect.TypeFor[syntax.BashPPSelectorExpr](),
	...
	"BashPPApproxType":     reflect.TypeFor[syntax.BashPPApproxType](),
	"BashPPCollectionType": reflect.TypeFor[syntax.BashPPCollectionType](),
	...
	"BashPPCompositeElem":  reflect.TypeFor[syntax.BashPPCompositeElem](),
	"BashPPAssign":         reflect.TypeFor[syntax.BashPPAssign](),
	"BashPPCall":           reflect.TypeFor[syntax.BashPPCall](),
	"BashPPCommandCall":    reflect.TypeFor[syntax.BashPPCommandCall](),
	"BashPPImport":         reflect.TypeFor[syntax.BashPPImport](),
	"BashPPImportSpec":     reflect.TypeFor[syntax.BashPPImportSpec](),
	"BashPPFuncDecl":       reflect.TypeFor[syntax.BashPPFuncDecl](),
	"BashPPDecorator":      reflect.TypeFor[syntax.BashPPDecorator](),
	"BashPPAgenticBlock":   reflect.TypeFor[syntax.BashPPAgenticBlock](),
	"BashPPReceiver":       reflect.TypeFor[syntax.BashPPReceiver](),
	"BashPPFuncLit":        reflect.TypeFor[syntax.BashPPFuncLit](),
	"BashPPField":          reflect.TypeFor[syntax.BashPPField](),
	"BashPPTypeParam":      reflect.TypeFor[syntax.BashPPTypeParam](),
	"BashPPTypeArg":        reflect.TypeFor[syntax.BashPPTypeArg](),
	"BashPPReturn":         reflect.TypeFor[syntax.BashPPReturn](),
	"BashPPDefer":          reflect.TypeFor[syntax.BashPPDefer](),
	"BashPPIf":             reflect.TypeFor[syntax.BashPPIf](),
	"BashPPFor":            reflect.TypeFor[syntax.BashPPFor](),
	"BashPPForAssign":      reflect.TypeFor[syntax.BashPPForAssign](),
	...
	"BashPPChanType":       reflect.TypeFor[syntax.BashPPChanType](),
	"BashPPMakeChan":       reflect.TypeFor[syntax.BashPPMakeChan](),
	"BashPPSend":           reflect.TypeFor[syntax.BashPPSend](),
	"BashPPReceive":        reflect.TypeFor[syntax.BashPPReceive](),
	"BashPPClose":          reflect.TypeFor[syntax.BashPPClose](),
	"BashPPSelect":         reflect.TypeFor[syntax.BashPPSelect](),
	"BashPPSelectCase":     reflect.TypeFor[syntax.BashPPSelectCase](),
	"BashPPRange":          reflect.TypeFor[syntax.BashPPRange](),
